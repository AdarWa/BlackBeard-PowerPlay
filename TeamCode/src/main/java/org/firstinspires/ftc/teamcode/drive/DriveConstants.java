...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 0.53185953177; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 8.85826772; // in
    ...
    public static double kStatic = 0.06512;
