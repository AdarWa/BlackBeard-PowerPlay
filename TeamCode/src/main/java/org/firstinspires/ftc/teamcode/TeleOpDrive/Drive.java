...
public class Drive {
    ...
    private Drive.DriveMode mode = Drive.DriveMode.JokerDrive;
    ...
    public void update(){
        ...
        if(mode == Drive.DriveMode.JokerDrive)
    ...
    private void changeModeByLeftBumper(){
        mode = driver.wasJustPressed(GamepadKeys.Button.LEFT_BUMPER) ? mode  == Drive.DriveMode.JokerDrive ? Drive.DriveMode.RegularDrive : Drive.DriveMode.JokerDrive : mode;
    }
